          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-28 items-start">
            <div>
              ...
              <p style={{ fontSize: 16, lineHeight: 1.8, color: `${C.space}bb`, marginTop: 20 }}>
               Our programme takes place over four Saturdays, with each session combining classroom learning with engaging, hands-on activities. The final session is extended, giving students more time for activities, reflection, and a proper goodbye. 
              </p>
            </div>
      ...
      <section className="py-24 lg:py-36" style={{ backgroundColor: C.space }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-4 gap-x-8">
            {[
              "Aahan Jain", "Aayesha Dadhiwale", "Advik Kalangutkar", "Devansh Goyal",
              "Dheer Vikamshi", "Hrithik Vhora", "Jay Dalya", "Jhalak Jain",
              "Mahi Singh", "Ojas Kadam", "Phalghuni Panchgavi", "Pravesh Lohana",
              "Prithviraj Mote", "Rhythm Patel", "Sarah Patel", "Vedika Bagri"
            ].map(name => (
...
>
  ...
  >
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
      <rect x="4" y="3" width="16" height="18" rx="1.5" stroke={C.caput} strokeWidth="1.5"/>
      <line x1="8" y1="8" x2="16" y2="8" stroke={C.caput} strokeWidth="1.2"/>
      <line x1="8" y1="11" x2="16" y2="11" stroke={C.caput} strokeWidth="1.2"/>
      <line x1="8" y1="14" x2="13" y2="14" stroke={C.caput} strokeWidth="1.2"/>
      <rect x="6.5" y="6.5" width="2" height="8" fill={C.caput}/>
    </svg>
